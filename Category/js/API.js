     ...
     success: function(wb){
     	//console.log(wb);
                ...
                wb.forEach(function(d){
                	...
                	console.log("dfghj")
                	$("#"+((d.category).replace(/\s/g,''))+"_eventname").append("<li>"+(d.event_name).replace(/\s/g,'')+"</li>");
                ...
                <div role="tabpanel" class="tab-pane event_specific_details_to_show" id="event_tab_'+(d.event_name).replace(/\s/g,'')+'">\
